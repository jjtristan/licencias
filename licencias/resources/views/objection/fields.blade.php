...
<div class="form-group @if($errors->first('first_position_person_id')) has-error @endif">
    ...
    {!! Form::select('first_person_position_id', $positions, null, ['class' => 'form-control', 'placeholder' => 'Selecciona una posición...']) !!}
</div>
...
<div class="form-group @if($errors->first('second_position_person_id')) has-error @endif">
    ...
    {!! Form::select('second_person_position_id', $positions, null, ['class' => 'form-control', 'placeholder' => 'Selecciona una posición...']) !!}
</div>
